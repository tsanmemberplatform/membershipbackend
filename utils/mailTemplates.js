      ...
      <div style="max-width:600px; margin:0 auto; background:#fff; border-radius:10px; overflow:hidden; box-shadow:0 4px 10px rgba(0,0,0,0.1);">
        ...
        <div style="padding:30px; color: #333;">
          ...
          <p style="font-size:14px; color:#555; line-height:1.6;">
            ...
            via email <a href="mailto:websupport@scouts.org.ng" style="color:#2e6da4; text-decoration:none;">websupport@scouts.org.ng</a>.
          </p>
  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <p>If you did not initiate this action, please contact us immediately at <a href="mailto:websupport@scouts.org.ng">websupport@scouts.org.ng</a>.</p>
